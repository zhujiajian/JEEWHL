			...
			},
			{
				...
				btnClick: function () {
					...
					JEE.confirmMsg("是否确认删除数据？", function(){
						$.when(JEE.myAjax("/master/basDock/delete", {ids: ids})).done(function(result){
							$("#myModal").hide();
	...
	JEE.initDialog({
		...
		btnItems: [{
			...
			btnClick: function (data) {
				...
				var url = change == "edit" ? "/master/basDock/update" : "/master/basDock/add";
