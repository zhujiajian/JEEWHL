$(function () {
	...
	JEE.initTable({
			...
			},
			{
				...
				btnClick: function () {
					...
					JEE.confirmMsg("是否确认删除数据？", function(){
						$.when(JEE.myAjax("/master/basWorkshop/delete", {ids: ids})).done(function(result){
							$("#myModal").hide();
		...
		url: "/master/basWorkshop/findByPage",
	...
	JEE.initDialog({
		...
		btnItems: [{
			...
			btnClick: function (data) {
				...
				var url = change == "edit" ? "/master/basWorkshop/update" : "/master/basWorkshop/add";
